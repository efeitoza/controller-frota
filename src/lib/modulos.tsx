...
export const MODULOS: Modulo[] = [
  ...
  {
    prefixo: "/mais/acessos",
    titulo: "Acessos",
    frase: "Crie usuários, defina o perfil e redefina senhas.",
    Icone: IconeEquipe,
    circulo: "bg-teal-400/15 text-teal-300",
    destaque: "text-teal-700",
  },
  {
    prefixo: "/mais/condutores",
    titulo: "Condutores",
    frase: "Ficha da equipe: matrícula, contato e veículo.",
    Icone: IconeEquipe,
    circulo: "bg-teal-400/15 text-teal-300",
    destaque: "text-teal-700",
  },
  {
    prefixo: "/mais/veiculos",
    titulo: "Veículos",
    frase: "Frota cadastrada, hodômetro e histórico de custos.",
    Icone: IconeMoto,
    circulo: "bg-sky-400/15 text-sky-300",
    destaque: "text-sky-700",
  },
  {
    prefixo: "/mais/epi",
    titulo: "EPI",
    frase: "Equipamentos entregues ao condutor.",
    Icone: IconeEpi,
    circulo: "bg-lime-400/15 text-lime-300",
    destaque: "text-lime-700",
  },
  {
    prefixo: "/mais/operacao",
    titulo: "Operação",
    frase: "Linhas, terminais, consorciadas, veículos e motivos.",
    Icone: IconeOperacao,
    circulo: "bg-indigo-400/15 text-indigo-300",
    destaque: "text-indigo-700",
  },
  {
    prefixo: "/mais",
    titulo: "Mais",
