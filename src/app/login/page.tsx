...
export default function Login() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-lg flex-col justify-center bg-gradient-to-b from-brand-800 to-brand-600 px-6 py-10">
      <div className="mb-8 text-center text-white">
        ...
        <p className="mt-1 text-[13.5px] text-brand-100">Gestão de condutores e frota</p>
      </div>
      ...
      {!temSupabase && (
        <p className="mt-5 rounded-xl bg-white/10 p-3 text-center text-[12.5px] leading-relaxed text-brand-50">
